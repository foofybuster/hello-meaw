...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHelloBidiStream = channel.stream_stream(
                ...
                response_deserializer=helloworld__pb2.HelloReply.FromString,
                _registered_method=True)
        self.Doopzeem = channel.stream_stream(
                '/helloworld.Greeter/Doopzeem',
                request_serializer=helloworld__pb2.HelloRequest.SerializeToString,
                response_deserializer=helloworld__pb2.HelloRequest.FromString,
                _registered_method=True)
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Doopzeem': grpc.stream_stream_rpc_method_handler(
                    servicer.Doopzeem,
                    request_deserializer=helloworld__pb2.HelloRequest.FromString,
                    response_serializer=helloworld__pb2.HelloRequest.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def Doopzeem(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            '/helloworld.Greeter/Doopzeem',
            helloworld__pb2.HelloRequest.SerializeToString,
            helloworld__pb2.HelloRequest.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
